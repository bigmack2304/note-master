...
function TableInput({ hValue, onChange, onBlur, className, inputProps }: TTableInputProps) {
    return <Input type="text" defaultValue={hValue.value} autoComplete="off" className={className} inputProps={inputProps} onChange={onChange} onBlur={onBlur} />;
}

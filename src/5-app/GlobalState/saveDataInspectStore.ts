...
const saveDataInspectSlice = createSlice({
  ...
  reducers: {
    setCurrentFolder: (
      state,
      action: PayloadAction<ISaveDataInspectStore["currentFolder"]>
    ) => {
      state.currentFolder = action.payload;
    },
    setCurrentNote: (
      state,
      action: PayloadAction<ISaveDataInspectStore["currentNote"]>
    ) => {
...
export const { setCurrentFolder, setCurrentNote, updateNote } =
